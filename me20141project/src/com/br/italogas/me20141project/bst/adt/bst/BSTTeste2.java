...
public class BSTTeste2 {
	
	protected BSTImpl<Integer> tree1;
	protected BSTImpl<Integer> tree2;
	protected BSTImpl<Integer> tree3;
	protected BSTImpl<Integer> tree4;
	...
	@Test
	public void testNumberOfLeafs() {
		assertEquals(1, tree1.numberOfLeafs());
		assertEquals(1, tree2.numberOfLeafs());
		assertEquals(4, tree3.numberOfLeafs());
		assertEquals(0, tree4.numberOfLeafs());
	}
	
	@Test
	public void testDescendingOrder(){
		assertArrayEquals(new Integer[]{9,8,6,5,4,3,1}, tree3.descendingOrder());
	}
	
	@Test
	public void testEqualTrees(){
		BSTImpl<Integer> testTree = new BSTImpl<Integer>();
		testTree.insert(5);
		testTree.insert(3);
		testTree.insert(1);
		testTree.insert(4);
		...
		assertTrue(tree3.equalTrees(testTree));
		assertFalse(tree3.equalTrees(tree4));
	}
